...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('which_page', models.CharField(choices=[('index', '首页'), ('login', '登录页面'), ('regist', '注册页面'), ('forgetpwd', '密码找回页面')], default='index', max_length=20)),
                ('title', models.CharField(blank=True, max_length=20, null=True, verbose_name='轮播标题')),
                ('info', models.CharField(blank=True, max_length=50, null=True, verbose_name='轮播信息')),
                ('url', models.CharField(blank=True, max_length=120, null=True, verbose_name='轮播链接')),
                ('image', models.ImageField(blank=True, default='image/default.png', null=True, upload_to='image/%Y/%m', verbose_name='轮播图片')),
            ],
            options={
                'verbose_name': '轮播图',
